...
if (isset($_POST['update_pribadi'])) {
       ...
       $anak_yatim = trim(mysqli_real_escape_string($con, $_POST['anak_yatim']));
       ...
       mysqli_query($con, "UPDATE  tb_siswa SET nama_siswa='$nama_siswa',tpt_lahir='$tpt_lahir',tgl_lahir='$tgl_lahir',jk='$jk',anakke='$anakke', jml_saudara='$jml_saudara',anak_yatim='$anak_yatim',hobi='$hobi',cita='$cita',alamat='$alamat',no_rumah='$no_rumah',
  ...
  <div class='alert alert-info alert-dismissible'>
                ...
                <a href='?page=edit1' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
              </div>
              </div>
              </div> ";
  ...
  <div class='alert alert-info alert-dismissible'>
                ...
                <a href='?page=edit2' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
              </div>
              </div>
              </div> ";
  ...
  <div class='alert alert-info alert-dismissible'>
                ...
                <a href='?page=edit3' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
              </div>
              </div>
              </div> ";
  ...
  <div class='alert alert-info alert-dismissible'>
                ...
                <a href='?page=edit4' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
              </div>
              </div>
              </div> ";
  ...
  <div class='alert alert-info alert-dismissible'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <center><h2><i class='icon fa fa-check'></i> Sukses!</h2>
                <h3>Data Pendidikan Berhasil Terupdate !!</h3> <br>
                <a href='?page=edit5' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
              </div>
              </div>
              </div> ";
       ...
       $kd_ijazah = $_POST['kd_ijazah'];
        $ket = $_POST['ket'];
          ...
          <a href='?page=edit6' class='btn bg-maroon margin btn-lg'><i class='fa fa-check'> OK</i></a></center>
          </div>
          </div>
          </div> ";
