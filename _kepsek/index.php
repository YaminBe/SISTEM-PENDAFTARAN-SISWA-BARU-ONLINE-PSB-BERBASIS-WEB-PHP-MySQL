...
<head>
  ...
  <title>Halaman Kepsek || MA KMM Kauman</title>
...
?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?page=l_pendaftar"><i class="fa fa-circle-o"></i> Laporan Pendaftar</a></li>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-home"></i> Halaman Kepala Sekolah
        <small><?php echo date (" d F Y") ?></small>
      </h1>
    </section>
