...
<h3 class="box-title"> <i class="fa fa-print"></i> LAPORAN DATA PENDAFTAR "TIDAK LULUS"</h3>
</div>
<!-- /.box-header -->
<div class="box-body">
...
<div style="margin-bottom: 19px;">
 ...
 <a href="Page/Laporan/lap_tlulus.php" class="btn btn-success"><i class="fa fa-print"></i> Export Ke Excell</a>
