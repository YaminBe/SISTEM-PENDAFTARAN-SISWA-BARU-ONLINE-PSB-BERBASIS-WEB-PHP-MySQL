                    ...
                    <table class="table table-striped table-hover table-bordered">
                      ...
                      <tbody>
                          ...
                          <td class="text-center">
                            <a href="?page=cek&id=<?=$data['id_siswa'];?>" class="btn btn-info"><i class="fa fa-check"></i> Cek Data</a>

                            <a href="?page=status&id=<?=$data['id_siswa'];?>" class="btn btn-warning"><i class="fa fa-edit"></i> Proses</a>                          
                          </td>
                        </tr>
                              <?php
