        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#pddk" data-toggle="tab"> <i class="fa fa-users"></i> Keterangan Pendidikan</a></li>
              ...
              <li><a href="#settings1" data-toggle="tab"><i class="fa fa-graduation-cap"></i> Data Nilai Siswa</a></li>
                <li><a href="#ijazah" data-toggle="tab"><i class="fa fa-graduation-cap"></i> File Ijazah</a></li>
            </ul>
        ...
        <div class="col-xs-6">
          ...
          <!-- /.row -->
              ...
              <div class="tab-pane" id="pddk">
                <?php
$id = @$_GET['id'];
$sql = mysqli_query($con,"select * from tb_pddk where id_siswa = '$id'") or die(mysqli_error($con));
$data = mysqli_fetch_array($sql);
?>
                  <form action="?page=proses" method="post">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"><span class="label label-success">Keterangan Pendidikan</span></h3>
                </div>
                <div class="box-body">
...
?>
          <form action="?page=proses" method="post">
            ...
            <div class="tab-pane" id="ijazah">
              <?php
$id = @$_GET['id'];
$sql = mysqli_query($con,"select * from tb_ijazah where id_siswa = '$id'") or die(mysqli_error($con));
$data = mysqli_fetch_array($sql);
?>
     ...
     <img src="../foto/ijazah/<?=$data['foto']?>" class="img-thumbnail" width="100"><br>
