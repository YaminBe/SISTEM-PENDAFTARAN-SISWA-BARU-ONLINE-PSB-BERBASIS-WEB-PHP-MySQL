...
<div class="login-box">
  ...
  <div class="login-box-body" style="border-radius: 10px 10px 10px 10px; border:2px solid #4a148c;">
    ...
    <p class="text-left"><b style="color: #4a148c;">Admin / Kepsek</b></p> <br>
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="form-group has-feedback">
        <select name="level" class="form-control" style="border-radius: 100px; background-color: #4a148c; color: white; height: 40px;">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <input type="submit" name="login" class="btn btn-info btn-block" value="Login" style="border-radius: 100px; outline: none;">
...
if (@$_POST['login']) {
  ...
  if ($level == 'admin') {
      $sql = mysqli_query($con,"SELECT * FROM tb_admin WHERE username ='$user' AND password='$pass' ") or die(mysqli_error($con)) ;
      ...
      <?php              
        ...
        ";
              ...
              $sql = mysqli_query($con,"SELECT * FROM tb_admin WHERE username ='$user' AND password='$pass' ") or die($db -> $error) ;
              $data = mysqli_fetch_array($sql);
              $id = $data [0];
              $cek = mysqli_num_rows($sql);
